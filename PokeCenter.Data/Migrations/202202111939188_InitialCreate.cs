    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        PCardId = c.Int(nullable: false, identity: true),
                        OwnerId = c.Guid(nullable: false),
                        CardName = c.String(nullable: false),
                        CardGrade = c.Int(nullable: false),
                        CardPrice = c.Int(nullable: false),
                        IsHolo = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.PCardId);
            
            CreateTable(
                "dbo.PGame",
                c => new
                    {
                        PGameId = c.Int(nullable: false, identity: true),
                        OwnerId = c.Guid(nullable: false),
                        GameName = c.String(nullable: false),
                        Console = c.String(nullable: false),
                        GamePrice = c.Int(nullable: false),
                        HasCase = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.PGameId);
